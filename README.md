...
### Purchase AR Tokens
Tokens can be purchased at either [gate.io](https://www.gate.io/) or [huobi.com](https://www.huobi.com/en-us/), or you can swap for them in [this pool](https://etherscan.io/token/0x4fadc7a98f2dc96510e42dd1a74141eeae0c1543)[https://info.uniswap.org/#/pools/0x3afec5673a547861877f4d722a594171595e561b] on Uniswap. You likely won't need very many tokens since the cost of storage is relatively cheap. You can check to see how much storage costs in both Arweave tokens (AR) and USD by running `cargo run arweave price 1000000`, which will give the cost of uploading 1 megabyte.
